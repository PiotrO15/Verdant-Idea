...
ServerEvents.recipes(event => {
  ...
  event.recipes.botania.runic_altar('matc:prudentium_crystal', ['mysticalagriculture:coal_essence', 'mysticalagriculture:copper_essence', 'mysticalagriculture:iron_essence', 'mysticalagriculture:dye_essence'].concat(multi('mysticalagriculture:prudentium_essence', 4)), 12500)
  ...
  event.recipes.botania.runic_altar('matc:imperium_crystal', ['mysticalagriculture:aluminum_essence', 'mysticalagriculture:diamond_essence', 'mysticalagriculture:emerald_essence', 'mysticalagriculture:end_essence', 'mysticalagriculture:gold_essence', 'mysticalagriculture:tin_essence', 'mysticalagriculture:blaze_essence', 'mysticalagriculture:creeper_essence', 'mysticalagriculture:enderman_essence'].concat(multi('mysticalagriculture:imperium_essence', 4)), 50000)
